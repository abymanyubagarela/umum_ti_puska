...
class UsersRoomLoanController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('frontend.roomsLoan.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('frontend.roomsLoan.create', $data);
    ...
    public function store(StoreRoomLoanRequest $request)
    {
        ...
        return redirect('/pinjam-ruang')->with('success', 'Data berhasil di tambahkan');
    }
    ...
    public function edit(RoomLoan $roomLoan)
    {
        ...
        return view('frontend.roomsLoan.edit', $data);
    }
    ...
    public function update(UpdateRoomLoanRequest $request, RoomLoan $roomLoan)
    {
        ...
        return redirect('/pinjam-ruang')->with('success', 'Data berhasil diubah');
    }
    ...
    public function getDataTableProperty(Request $request)
    {
        if ($request->ajax())
        {
            ...
            {
                if($row->status == 1){
                    $actionBtn = '<a href="/pinjam-ruang/' . $row->id . '/edit" class="edit open_modal badge bg-success btn-sm">Detail</a> <button value="' . $row->id . '"class="delete delete-product badge bg-danger btn-sm">Delete</button>';
                    } else{
                        $actionBtn = '<span class="inline badge w-100  bg-success"> Done </span>';
                    }
                return $actionBtn;
