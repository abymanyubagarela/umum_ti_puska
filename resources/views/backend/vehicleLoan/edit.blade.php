        ...
        <div class="container mt-4">
            <div class="container-form-export container-form-additional mb-4">
                <div class="row ">
                    ...
                    @endif
                    <input type="hidden" id="vehicleLoanInput" value="{{ $vehicleLoan->id }}" />
                    <form class="row g-3" method="post" action="/backend/vehicleLoan/{{ $vehicleLoan->id }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="col-md-4">
                            ...
                            <select class="select2input form-select" name="account_id" required>
                                ...
                                @if(old('account_id', $vehicleLoan->account_id) == $account->id)
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="select2input form-select" name="driver_id" required>
                                ...
                                @if(old('driver_id', $vehicleLoan->driver_id) == $driver->id)
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="select2input form-select" name="vehicle_id" required>
                                ...
                                @if(old('vehicle_id', $vehicleLoan->vehicle_id) == $vehicle->id)
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tanggal" class="form-control" value="{{ old('tanggal', $vehicleLoan->tanggal) }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Waktu Peminjaman</label>
                            <input type="time" name="waktu" class="form-control" value="{{ old('waktu', $vehicleLoan->waktu) }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Tujuan</label>
                            <textarea name="tujuan" class="form-control" value="{{ old('tujuan', $vehicleLoan->tujuan) }}" required> {{ old('tujuan', $vehicleLoan->tujuan) }}</textarea>
                        </div>

                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Keperluan</label>
                            <textarea name="keperluan" class="form-control" required> {{ old('keperluan', $vehicleLoan->keperluan) }} </textarea>
                        </div>
