...
<div class="row mt-3">
    <div class="card p-4">
            ...
            @endif
            <h4 for="inputDetail" class="col-sm-3 control-label">Peminjaman Buku</h4>
        <div class="form-group mb-3 col-md-12">
            <form action="{{ route('exportReportIndexBookPinjam.export') }}" method="POST" class="row" enctype="multipart/form-data">
                @csrf
