...
Route::group(['middleware' => 'auth'], function ()
{
    ...
    Route::get('/backend/dashboard/keterlambatan', [DashboardControllers::class , 'dashboardKeterlambatan']);

    Route::resource('/backend/books', BooksController::class);
    Route::post('/backend/books/export', [BooksController::class,'export']);
